  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        // 保险年度预测统一转换成数组
        //
        // 兼容 getInsuranceYearProjection()
        // 返回数组或 { data / rows / projection } 的情况。
        // =================================================
        ...
        for (
          ...
          const totalFuturePremium =
            toNumber(
              ...
              insuranceYear?.total_future_premium ??
              insuranceYear?.futurePremiumTotal ??
              insuranceYear?.future_premium_total ??
              insuranceYear?.unpaidPremium ??
              insuranceYear?.unpaid_premium
            );
          ...
          const coupleFuturePremium =
            toNumber(
              ...
              insuranceYear?.couple_future_premium ??
              insuranceYear?.coupleUnpaidPremium ??
              insuranceYear?.couple_unpaid_premium
            );
          ...
          const yearSonCashValue =
            toNumber(
              insuranceYear?.sonCashValue ??
              insuranceYear?.son_cash_value ??
              insuranceYear?.sonCashValueAtYear ??
              insuranceYear?.son_cash_value_at_year
            );
        ...
        >
          ...
          >
            ...
            <p>
              ...
              使用 FREEDOM PAGE 相同的「年末预计资产」计算，而不是使用当前资产。
