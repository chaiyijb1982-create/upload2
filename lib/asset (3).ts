...
//
// 重要：
// Dashboard Total Wealth 直接使用
// asset_history.total_asset
//
// 这里绝对不要再加 fixed_income_assets。
// 否则会导致固收重复计算。
// =====================================
...
// 注意：
// 只有当某个页面明确需要把
// asset_history + fixed_income_assets
// 合并时才使用。
//
// 如果 asset_history 已经包含固收，
// 就不要使用这个函数。
// =====================================
